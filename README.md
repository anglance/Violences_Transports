...
Au cours de cette étude, nous avons pu constater plusieurs limites à cette base de données: des limites de catégorisation avec le choix de séparer l’Île de France et le reste de la France, mais aussi dans le traitement des dépôts de plainte. Ces limites propres au choix de la base de données ont pour conséquence un biais de présentation dans les médias par les politiques. 
Une des limites propres à la catégorisation est la distinction géographique faite entre l'Île de France et le reste du territoire français. Cela ne semble pas rendre compte de la diversité et de la complexité des territoires urbains et ruraux en dehors de l’Île de France laisse à la marge des statistiques intéressantes au niveau des autres grandes métropoles. Il est en effet dommage de ne pas pouvoir comparer dès la base de données ces métropoles avec l’Île de France, il faut attendre les annexes pour apercevoir un jeu de données par grandes métropoles. De plus, même si le besoin de catégoriser répond à un enjeu de clarté et de concision dans le but de mieux évaluer les démarches à faire et mieux faire ressortir les problématiques et les réponses qu’elles appellent, il est regrettable de constater que la catégorisation des  dépôts de plainte ne puissent être plus précis que cela. En effet, alors qu’un dépôt de plainte peut répondre à plusieurs critères en même temps et ainsi rentrer dans plusieurs catégories. Il est évident qu’il a fallu les classer, ce qui fait perdre en précision sur le phénomène global. Si cet effort est nécessaire à la lecture globale, il n’en reste pas moins un biais.  

Cette étude statistique a logiquement été reprise par des femmes et hommes politiques tant pour montrer les efforts réalisés par rapport aux précédents rapports que pour les utiliser à des fins démagogiques. Ainsi, le 12 juillet dernier, le président du RN Jordan Bardella a repris cette étude et a affirmé sur le plateau de France Info que “95% de la délinquance de rue en France est liée à l’immigration”. Bien qu’il ait déclaré: “La source, vous parlez avec les policiers, vous parlez avec les magistrats” dans un premier temps, Jordan Bardella répond ensuite “Le service statistique du ministère de l’Intérieur nous dit que 93% des vols qui sont commis dans les transports en commun d’Île-de-France sont le fait d’étrangers.” C’est donc un premier exemple de récupération politique de cette base de données. En revanche, il convient de préciser que la déclaration est fallacieuse. En effet 93% des vols sans violence commis dans les transports en commun d’Île-de-France sont le fait d’étrangers, et non tous les vols commis dans les transports en commun de la région parisienne. L’homme politique a donc savamment manipulé les données de afin de les présenter comme il le souhaitait. 
D’un autre spectre politique et de la majorité présidentielle, c’est l’actuel ministre de l’Intérieur, Gérald Darmanin qui a aussi repris les données de cette étude pour vanter les mérites de son action. Sur les réseaux sociaux, dans les médias traditionnels, le ministre a annoncé à l’AFP dès le 11 octobre les bons chiffres de cette étude, les vols avec violences ayant baissé de 22,70% sur la même période. Ainsi les données de la même étude du SSMSI sont utilisées de manière différente, de manière fiable ou non, par différents hommes et femmes politiques issus de partis différents. On remarque le traitement de l'information, le message passé et l’utilisation politique dans les médias de cette étude très politisée. 
